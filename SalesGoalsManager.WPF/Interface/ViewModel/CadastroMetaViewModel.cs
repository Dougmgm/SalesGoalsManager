...
using WpfDto = SalesGoalsManager.WPF.RegraDeNegocio.Dto;
...
namespace SalesGoalsManager.WPF.Interface.ViewModel
{
    public class CadastroMetaViewModel : ViewModelBase
    {
        ...
        private readonly MetaCadastro _metaCadastro = ServiceFactory.CriarMetaCadastro();
        private readonly ProdutoConsulta _produtoConsulta = ServiceFactory.CriarProdutoConsulta();
        private readonly VendedorConsulta _vendedorConsulta = ServiceFactory.CriarVendedorConsulta();
